...
const ICON_SHAPES: Record<ProductCategory, string> = {
  bag: `<path d="M24 20 v-6 a8 8 0 0 1 16 0 v6" fill="none" stroke="#111" stroke-width="4" stroke-linecap="round"/><polygon points="18,20 46,20 49,54 44,57 40,53 35,57 30,53 25,57 20,53 15,54"/>`,
  ...
  lid: `<rect x="4" y="44" width="56" height="10"/><rect x="18" y="28" width="28" height="18"/>`,
